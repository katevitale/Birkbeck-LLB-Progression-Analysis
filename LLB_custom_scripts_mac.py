...
def count_resit_and_retake(row_series, num_assessments):
    if row_series['Grade'] == 'F':
        print(num_assessments) # place-filler for code to write

def analyze_assessment_row(df, num_assessments):
    print(num_assessments) # place-filler for code to write
